...
if string.sub(model,1,2) == "iP" then
     ...
     if string.find(architectureInfo, "iPhone10,3") or string.find(architectureInfo, "iPhone10,6") then -- https://www.theiphonewiki.com/wiki/List_of_iPhones
        M.is_iPhoneX = true
     end

     if M.is_iPhoneX == false and M.isSimulator and display.pixelWidth == 1125 and display.pixelHeight == 2436 then
        M.is_iPhoneX = true
     end
